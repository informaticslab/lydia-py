STD Guidelines Content Generation Python Scripts for Mobile Apps (Lydia)
===========
STD Guidelines app will provide the 2014 STD Guidelines on iOS and Android smart phones. 
...
## Roadmap
* Updates for new 2014 content from CDC STD Tx Guidelines
